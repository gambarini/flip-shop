...
func setupTestEnv(t *testing.T) testEnv {
	...
	if err := kv.WithTx(func(tx utils.Tx) error {
		...
		tx.Write(repo.ItemStoreName, RaspberyPiSku, item.Item{Sku: RaspberyPiSku, Name: "Raspberry Pi B", QtyAvailable: 2, Price: 3000})
		return nil
	}); err != nil {
	...
	promos := []promotion.Promotion{
		promotion.FreeItemPromotion{PurchasedItemSku: ItemMacBookProSku, FreeItemSku: RaspberyPiSku, FreeItemPrice: 3000},
